...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/xodid/Documents/MATLAB/Examples/R2026a/autonomous_control/LaneKeepingAssistWithLaneDetectionExample
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
MW_raspi_init.c.o : $(MATLAB_ROOT)/toolbox/rpib/raspiML/src/MW_raspi_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_Pyserver_control.c.o : $(MATLAB_ROOT)/toolbox/rpib/raspiML/src/periphs/MW_Pyserver_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"
